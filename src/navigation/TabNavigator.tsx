...
function TabNavigator() {
  return (
      <Tab.Navigator initialRouteName="Inbox" screenOptions={{
          tabBarActiveTintColor: PRIMARY_COLOR,
          headerShown: true,
          headerTitleAlign: 'center',
          headerStyle : {backgroundColor: "white", borderBottomColor: "#c4c4c4", borderBottomWidth: 1 }
      }}>
        <Tab.Screen name="Inbox" component={Inbox} options={{
            ...
            headerRight: () => (
                <SearchIcon name="inbox" color={"lg"} size={10} />
            )
        }}/>
        <Tab.Screen name="My Files" component={MyFiles} options={{
            title: "My Files",
        ...
        <Tab.Screen name="My Account" component={HomeScreen2} options={{
