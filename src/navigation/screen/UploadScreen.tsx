...
import { camelCap } from "../../component/Body";
    ...
    >
      <Box w="70%" alignItems="center" mb="$3" backgroundColor="transparent">
        <Text size="sm" color="$black">
          This file is not attached to a patient.
        </Text>
      </Box>
      <Box w="90%">
...
const ActionBar = () => {
  ...
  return (
    <Box w="100%" my="$2" justifyContent="space-around" flexDirection="row">
      <Box {...iconLayout}>
...
const Container = ({ navigation, route, options, back }) => {
  ...
  return (
    <Box flex={0} backgroundColor="transparent" h="100%">
      <ScrollView backgroundColor="transparent" h="100%">
        <Box height={300} w="100%" alignItems="center">
          <Image
            size="full"
            borderRadius="$none"
            source={{
        ...
        <Box textAlign="left" height="$10">
          <Text size="lg" mt="$3" mb="$1" mx="$3" color={TEXT_COLOR}>
            File details
          </Text>
        </Box>
          ...
          <Box alignSelf="center" mr="$3">
            <Pressable
              onPress={() => {
                ...
                navigation.navigate("BodySketch", { slug });
              }}
            >
              <MaterialCommunityIcons
                name="chevron-right"
        ...
        <Box textAlign="left" m="$3" mb="$1" h={140}>
          ...
          <Textarea size="sm" w="100%" borderWidth={0}>
