...
import { Box, Image, Fab } from "@gluestack-ui/themed";
...
function Container({ navigation, route, options, back }) {
  ...
  const [permissionMicrophone, requestMicrophonePermission] =
  ...
  function toggleCameraType() {
    ...
    function take() {
        ...
        .then((...args) => {
          console.log("take11111111111111111111", args);
        });
    }
  ...
  function take1() {
    ...
    camera.takePictureAsync({
      onPictureSaved: (res) => {
        // setResource(res);
        navigation.replace("ImageManipulate", {
  ...
  // if (resource) {
  //   console.log("resource11111111111111111111", resource);
  //   return (
